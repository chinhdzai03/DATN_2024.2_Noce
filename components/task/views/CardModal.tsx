...
export default function CardModal() {
  ...
  return (
    <>
      <div
        className="fixed inset-0 bg-black/80 z-40 transition-opacity duration-300 animate-fadein"
      />
      <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={handleBackdropClick}>
        <div className="w-full max-w-xl px-2 sm:px-0">
          <div
            className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10 relative transition-transform duration-300 animate-zoom"
