  ...
  return (
    <motion.div 
        ...
        >
         ...
         >
            <path d="M14.5 3a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"></path>


         </svg> */}
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 48 48" className={`h-6 w-6 text-[${color}] stroke-[${color}]`}>
